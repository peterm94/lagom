declare module 'detect-collisions'
{
    ...
    export class Polygon extends Body
    {
         ...
         * @param {number} [padding = 0] The amount to pad the bounding volume when testing for potential collisions
         */
        constructor(x?: number, y?: number, points?: number[][], angle?: number, scale_x?: number, scale_y?: number,
                    padding?: number);
    ...
    export class Collisions
    {
         ...
         * @returns {Polygon}
         */
        createPolygon(x?: number, y?: number, points?: number[][], angle?: number, scale_x?: number, scale_y?: number,
                      padding?: number): Polygon;
